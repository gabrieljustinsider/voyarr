...
By installing, copying, or otherwise using the Software, you agree to be bound by these Terms. If you disagree with any part of the terms, then you may not use the Software.

## 2. Software License

The Software is provided under the open-source license specified in the `LICENSE` file included with the Software. These Terms do not alter any rights or obligations you have under that license.

## 3. User Responsibility and Content

Voyarr is a tool for managing digital media. You acknowledge and agree that:

*   **You are solely responsible** for the content you download, store, manage, and access using the Software.
...
We reserve the right, at our sole discretion, to modify or replace these Terms at any time. We will provide notice of any changes by updating the "Last Updated" date of these Terms and including the new version in the project's repository.
